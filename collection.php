    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        ...
        <div id="collection-page-product-title">
          ...
          <p>Whether a brew for yourself or one to keep your guests happy, our growing collection of teas will help assure there’s one for all occasions.</p>
        ...
        <div id="product-item-container">
          ...
          <div class="product-item" data-id="rooibos-orange">
            ...
            <div class="product-item-detail">
              ...
              <p class="product-item-category">Tisane</p>
              <p class="product-item-price">$18.40</p>
            </div>
          </div>
          ...
          <div class="product-item" data-id="chrysanthemum">
            ...
            <div class="product-item-detail">
              ...
              <p class="product-item-category">Pu Erh</p>
              <p class="product-item-price">$18.40</p>
            </div>
          </div>
          ...
          <div class="product-item" data-id="roasted-oolong">
            ...
            <div class="product-item-detail">
              ...
              <p class="product-item-category">Oolong</p>
              <p class="product-item-price">$18.40</p>
            </div>
          </div>
          ...
          <div class="product-item" data-id="genmaicha">
            ...
            <div class="product-item-detail">
              ...
              <p class="product-item-category">Green</p>
              <p class="product-item-price">$18.40</p>
            </div>
          </div>
          ...
          <div class="product-item" data-id="chamomile">
            ...
            <div class="product-item-detail">
              ...
              <p class="product-item-category">White</p>
              <p class="product-item-price">$18.40</p>
            </div>
          </div>
