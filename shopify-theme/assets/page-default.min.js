...
manic.ui.VideoContainer.prototype.on_element_click=function(event){if(this.is_ready==true)if(manic.IS_MOBILE==true)this.player.play()};manic.ui.VideoContainer.prototype.on_event_handler_04=function(event){};goog.provide("goog.events.KeyCodes");goog.require("goog.userAgent");
...
str_array[1],str_array[2]);else{console.log("manic.page.Page: there is too many slashes in the hash url...");this.scroll_to_target(str_array[0],str_array[1],str_array[2])}}else this.on_scroll_to_no_target()};manic.page.Page.prototype.on_scroll_to_no_target=function(){this.scroll_to(0)};goog.exportSymbol("manic.page.Page",manic.page.Page);goog.provide("kindred.page.Default");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("manic.page.Page");kindred.page.Default=function(options){manic.page.Page.call(this,options);this.options=$.extend(this.options,kindred.page.Default.DEFAULT,options);if($("body").hasClass("chinese-version"))manic.SITE_LANGUAGE="cn";if($("body").hasClass("bahasa-version"))manic.SITE_LANGUAGE="in"};goog.inherits(kindred.page.Default,manic.page.Page);
kindred.page.Default.DEFAULT={};kindred.page.Default.EVENT_01="";kindred.page.Default.EVENT_02="";
...
"autoplay":true,"autoplaySpeed":4E3,"responsive":[{"breakpoint":1180,"settings":{"slidesToShow":4,"slidesToScroll":4}},{"breakpoint":1010,"settings":{"slidesToShow":3,"slidesToScroll":3}}]});if($("#home-instagram-item-container").length!=0)$("#home-instagram-item-container").slick({"speed":350,"dots":false,"arrows":false,"infinite":false,"slidesToShow":6,"slidesToScroll":1,"pauseOnHover":false,"autoplay":true,"autoplaySpeed":1E3,"responsive":[{"breakpoint":1380,"settings":{"slidesToShow":5,"slidesToScroll":1}},
{"breakpoint":1180,"settings":{"slidesToShow":4,"slidesToScroll":1}},{"breakpoint":980,"settings":{"slidesToShow":3,"slidesToScroll":1}}]});console.log("kindred.page.Default: init")};kindred.page.Default.prototype.private_method_04=function(){};kindred.page.Default.prototype.private_method_05=function(){};kindred.page.Default.prototype.private_method_06=function(){};kindred.page.Default.prototype.public_method_03=function(){};kindred.page.Default.prototype.public_method_04=function(){};
kindred.page.Default.prototype.public_method_05=function(){};kindred.page.Default.prototype.public_method_06=function(){};kindred.page.Default.prototype.update_page_layout=function(){kindred.page.Default.superClass_.update_page_layout.call(this)};kindred.page.Default.prototype.on_event_handler_01=function(event){};kindred.page.Default.prototype.on_event_handler_02=function(event){};kindred.page.Default.prototype.on_event_handler_03=function(event){};
