...
kindred.component.DesktopInstagramSlider.prototype.on_event_handler_03=function(event){};kindred.component.DesktopInstagramSlider.prototype.on_event_handler_04=function(event){};kindred.component.DesktopInstagramSlider.prototype.sample_method_calls=function(){kindred.component.DesktopInstagramSlider.superClass_.method_02.call(this)};goog.provide("goog.events.KeyCodes");goog.require("goog.userAgent");
...
str_array[1],str_array[2]);else{console.log("manic.page.Page: there is too many slashes in the hash url...");this.scroll_to_target(str_array[0],str_array[1],str_array[2])}}else this.on_scroll_to_no_target()};manic.page.Page.prototype.on_scroll_to_no_target=function(){this.scroll_to(0)};goog.exportSymbol("manic.page.Page",manic.page.Page);goog.provide("kindred.page.Default");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("manic.page.Page");goog.require("kindred.component.DesktopInstagramSlider");
kindred.page.Default=function(options){manic.page.Page.call(this,options);this.options=$.extend(this.options,kindred.page.Default.DEFAULT,options);if($("body").hasClass("chinese-version"))manic.SITE_LANGUAGE="cn";if($("body").hasClass("bahasa-version"))manic.SITE_LANGUAGE="in";this.desktop_instagram_slider=null};goog.inherits(kindred.page.Default,manic.page.Page);kindred.page.Default.DEFAULT={};kindred.page.Default.EVENT_01="";kindred.page.Default.EVENT_02="";
kindred.page.Default.prototype.init=function(){kindred.page.Default.superClass_.init.call(this);if($("#home-page-banner").length!=0)$("#home-page-banner").slick({"speed":350,"dots":false,"arrows":false,"infinite":false,"slidesToShow":1,"slidesToScroll":1,"pauseOnHover":false,"autoplay":true,"autoplaySpeed":4E3});if($("#home-page-shop-item-container").length!=0)$("#home-page-shop-item-container").slick({"speed":350,"dots":false,"arrows":true,"infinite":false,"slidesToShow":5,"slidesToScroll":5,"pauseOnHover":false,
"autoplay":true,"autoplaySpeed":4E3,"responsive":[{"breakpoint":1180,"settings":{"slidesToShow":4,"slidesToScroll":4}},{"breakpoint":1010,"settings":{"slidesToShow":3,"slidesToScroll":3}}]});if($("#home-instagram-slider").length!=0){this.desktop_instagram_slider=new kindred.component.DesktopInstagramSlider({},$("#home-instagram-slider"));goog.events.listen(this.desktop_instagram_slider,kindred.component.DesktopInstagramSlider.ON_INSTAGRAM_FEED_GENERATED,function(event){console.log("instagram feed generated");
